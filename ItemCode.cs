...
public class itemCode
{
    ...
    public Item.Weapon dagger = new Item.Weapon("단검", 1, 0, 300, 0, 1, "회피율을 증가시킨다.");
    public Item.Weapon longSword = new Item.Weapon("롱소드", 1, 0, 350, 0, 0, "효율이 좋아 인기가 많은 검이다.");
    public Item.Weapon bfSword = new Item.Weapon("B.F. 대검", 4, 0, 1300, 0, 1, "고가의 대검이다.");
